...
## 💬 Comment Prompt Reuse

Use the provided comment prompts as-is or adapt with filename, line number, and rule ID for GitHub inline comment generation.
...
1. Prioritize Security > AWS Best Practice > Performance > Readability
2. Limit comments per block to avoid noise
3. Always include `Rule ID` in the comment for traceability

---

*This file is RAG-optimized: short, rule-based, and structured to enable semantic search and regex scanning.*
